        ...
        <div class="col">
            <div class="container-fluid d-flex align-items-center justify-content-center" style="height:30vh;">
                <div class="card" style="width: 18rem;">
                    <div class="card-header text-center fs-4 text-white" style="background-color: rgb(77, 9, 9);">Vendedores   
                    </div>
                        <div class="card-body" style="background-color: rgb(77, 9, 9);">
            ...
            <div class="col">
                <div class="container-fluid d-flex align-items-center justify-content-center" style="height:30vh;">
                    <div class="card" style="width: 18rem;">
                        <div class="card-header text-center fs-4 text-white" style="background-color: rgb(77, 9, 9);">Administradores
                        </div>
                            <div class="card-body" style="background-color: rgb(77, 9, 9);">
